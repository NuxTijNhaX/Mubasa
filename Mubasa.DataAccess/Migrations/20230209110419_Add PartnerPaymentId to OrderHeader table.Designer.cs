...
namespace Mubasa.DataAccess.Migrations
{
    ...
    [Migration("20230209110419_Add PartnerPaymentId to OrderHeader table")]
    partial class AddPartnerPaymentIdtoOrderHeadertable
    {
            ...
            modelBuilder.Entity("Mubasa.Models.OrderHeader", b =>
                {
                    ...
                    b.Property<string>("PartnerPaymentId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
